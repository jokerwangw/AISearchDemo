...
public class MGSimpleDraweeView extends SimpleDraweeView {

    private MGSimpleListener mSimpleListener;
    private String mNodeId;

    public MGSimpleDraweeView(Context context, GenericDraweeHierarchy hierarchy) {
        super(context, hierarchy);
//        init();
    }
//      fix first png not load
//    private void init() {
...
//    }
    ...
    public MGSimpleDraweeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MGSimpleDraweeView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public MGSimpleDraweeView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
